...
|---|---|---|
| 01 Problem framing | `docs/stakeholder_memo.md` | Evaluate a transparent ETF allocation baseline for an investment analyst. |
...
| 07 Outliers | `src/outliers.py`, `docs/assumptions.md` | Flag market shocks and test sensitivity instead of deleting them automatically. |
